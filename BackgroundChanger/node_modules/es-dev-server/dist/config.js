...
function createConfig(config) {
  const {
    ...
    watchExcludes = [],
    http2 = false,
    compatibility = _constants.compatibilityModes.NONE,
    nodeResolve = false,
    ...
    logBabelErrors = true,
    logStartup
  } = config; // middlewares used to be called customMiddlewares
  // @ts-ignore
  ...
  let appIndexDir; // resolve appIndex relative to rootDir and transform it to a browser path
  ...
  if (typeof open === 'string' && open !== '') {
    ...
    openPath = _path.default.normalize(open);
  } else if (appIndex) {
