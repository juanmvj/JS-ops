...
exports.createTransformIndexHTMLMiddleware = createTransformIndexHTMLMiddleware;

var _path = _interopRequireDefault(require("path"));

var _url = require("url");

var _transformIndexHtml = require("../utils/transform-index-html.js");
 ...
 */
function createTransformIndexHTMLMiddleware(cfg) {
  ...
  async function transformIndexHTMLMiddleware(ctx, next) {
    ...
    const indexHTMLString = await (0, _utils.getBodyAsString)(ctx);
    const transformResult = (0, _transformIndexHtml.getTransformedIndexHTML)(ctx.url, indexHTMLString, cfg.compatibilityMode); // add new index.html

    ctx.body = transformResult.indexHTML; // cache index for later use

    indexHTMLData.set(ctx.url, { ...transformResult,
      lastModified
